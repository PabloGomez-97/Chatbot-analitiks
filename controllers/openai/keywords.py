...
keywords_human = [
    ...
    "quiero hablar", "hablar con ejecutivo", "hablar con un ejecutivo", "comunicarme", "teléfono", "representante", "consultor",
...
keywords_product = [
    ...
    "productos disponibles", "qué productos tienen", "qué ofrecen", "¿que productos tienen?", "¿que ofrecen?", "¿qué productos tienen?","qué ofrecen ustedes", "que ofrecen ustedes", "qué hay disponible", "que hay disponible", "qué tienen en catálogo",
    "que tienen en catalogo", "catálogo de productos", "catalogo de productos",
    "listado de productos", "listado", "muestras", "¿qué soluciones tienen?", 
    "¿que soluciones tienen?", "¿qué sistemas tienen?", "¿que sistemas tienen?"
]